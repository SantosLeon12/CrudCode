...
<html lang="en">
  ...
  <body>
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <form method="POST" action="<?php echo base_url().'/createUsuario'?>">
                        ...
                        <tr>
                            ...
                            <?php foreach($datos as $key):?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url().'/obtenerUsuario/'.$key->ID?>" class="btn btn-warning btn-sm">Editar</a></td>
                                    <td><a href="<?php echo base_url().'/deleteUsuario/'.$key->ID?>" class="btn btn-danger btn-sm">Eliminar</a></td>
                                </tr>
                            <?php endforeach; ?>
                    </table>
                </div>
